    ...
    public static function map() {
        return array(
            ...
            'ytaudio' => array(
                ...
                'items' => array(
                    'скачать аудио с ютуба в mp3'   => 'skachat-audio-s-yutuba-v-mp3',
                    'извлечь звук из видео онлайн'  => 'izvlech-zvuk-iz-video-onlayn',
                    'отделить звук от видео'        => 'otdelit-zvuk-ot-video',
                    'конвертировать mp4 в mp3'      => 'konvertirovat-mp4-v-mp3',
                    'вырезать аудио из видео'       => 'vyrezat-audio-iz-video',
                    'как вытащить музыку из видео'  => 'kak-vytashchit-muzyku-iz-video',
                    'скачать mp3 по ссылке'         => 'skachat-mp3-po-ssylke',
                    'скачать звук из рилс'          => 'skachat-zvuk-iz-rils',
                    'звук из видео в текст'         => 'zvuk-iz-video-v-tekst',
                    'скачать лекцию с ютуба'        => 'skachat-audiokngu-s-yutuba',
                    'сохранить звук на телефон'     => 'skachat-zvuk-iz-video-na-telefon',
                    'дорожка из видео для монтажа'  => 'zvukovaya-dorozhka-iz-video-skachat',
                ),
            ),
            'music' => array(
